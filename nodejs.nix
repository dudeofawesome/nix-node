...
let
  ...
  buildNodejs22 = import ./versions/22;
  buildNodejs20 = import ./versions/20;
  buildNodejs18 = import ./versions/18;
  buildNodejs16 = import ./versions/16;
  buildNodejs14 = import ./versions/14;
in
with pkgs; {
  packages =
    let
      v22_3_0 = (buildNodejs22 {
